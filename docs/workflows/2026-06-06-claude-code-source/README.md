...
Wave 1 is read-only truth reconciliation plus independent review:
...
The controller should synthesize both handoffs before launching any implementation slice.
