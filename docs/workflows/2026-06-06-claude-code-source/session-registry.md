...
| P1 release-prep | controller | `/Users/envvar/.codex/worktrees/4b9e/cxs` | `codex/claude-code-source-controller` | current release-prep HEAD | committed-pending-seal | version bumped to `0.3.5`; `npm run check`, `npm run build`, `npm pack --dry-run`, and registry readback `0.3.4` completed | `package.json` / `package-lock.json` | seal, push, open draft PR |
