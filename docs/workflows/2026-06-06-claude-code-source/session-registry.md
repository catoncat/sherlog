...
| L1 | controller | `/Users/envvar/.codex/worktrees/4b9e/cxs` | `codex/claude-code-source-controller` | current L1 HEAD | committed-pending-seal | C1 implementation, D1 docs, S1 skill source, and workflow handoffs integrated; `npm run check`, CLI help/readback, unsupported-source smokes, `npx skills ls -g --json`, and diff checks passed before commit | `completion-audit.md` / `milestone-plan.md` / `workflow-state.md` | run Mainline seal/lint |
